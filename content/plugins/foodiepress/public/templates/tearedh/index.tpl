        ...
        <div class="recipe-content">
            ...
            <div class="recipe-add-data">
                <ul>
                    ...
                    {if $rating }<li class="review hreview-aggregate"><em>{$lang.rating}</em>  <span class="rating"><span class="average">{$rating}</span> {$lang.stars} <span class="count">{$rating_nr}</span> {$lang.review}</span></li>{/if}
