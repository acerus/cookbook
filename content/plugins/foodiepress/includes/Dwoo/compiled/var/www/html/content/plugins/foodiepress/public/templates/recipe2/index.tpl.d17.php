...
?>
                        <li><span><a target="_blank" itemprop="ingredients" href="<?php echo $this->scope["item"]["url"];?>"><?php echo $this->scope["item"]["name"];?></a> <?php if ((isset($this->scope["item"]["note"]) ? $this->scope["item"]["note"]:null)) {
