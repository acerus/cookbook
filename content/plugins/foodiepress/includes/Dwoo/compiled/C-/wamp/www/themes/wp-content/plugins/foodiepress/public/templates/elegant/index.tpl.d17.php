...
?><em><?php echo $this->scope["lang"]["preptime"];?> :</em> <meta itemprop="prepTime" content="<?php echo $this->scope["preptimept"];?>"><?php echo $this->scope["preptime"];?>.<?php 
}?>

             <?php if ((isset($this->scope["cooktime"]) ? $this->scope["cooktime"] : null)) {
?><em><?php echo $this->scope["lang"]["cooktime"];?> :</em> <meta itemprop="cookTime" content="{ $cooktimept }"><?php echo $this->scope["cooktime"];

}?>

             <?php if ((isset($this->scope["yield"]) ? $this->scope["yield"] : null)) {
?><em><?php echo $this->scope["lang"]["yield"];?> :</em> <span itemprop="recipeYield"><?php echo $this->scope["yield"];?></span><?php 
}?>

             <?php if ((isset($this->scope["allergens"]) ? $this->scope["allergens"] : null)) {
?> <?php echo $this->scope["lang"]["allergens"];?> : <?php echo $this->scope["allergens"];?>  <?php 
}?>

             <?php if ((isset($this->scope["rating"]) ? $this->scope["rating"] : null)) {
?><p class="review hreview-aggregate"><em><?php echo $this->scope["lang"]["rating"];?></em>  <span class="rating"><span class="average"><?php echo $this->scope["rating"];?></span> <?php echo $this->scope["lang"]["stars"];?> <span class="count"><?php echo $this->scope["rating_nr"];?></span> <?php echo $this->scope["lang"]["review"];?></span></p><?php 
}?>
