...
;(function ( $, window, document, undefined ) {
	...
	$.fn.wc_variations_image_update = function( variation ) {
		var $form             = this,
			$product          = $form.closest('.product'),
			$product_img      = $product.find( 'div.productSlider img:eq(0)' ),
			$product_link     = $product.find( 'div.productSlider a.mfp-gallery:eq(0)' ),
			slider 			  = $(".productSlider").data('productSlider');
			var slider = $(".productSlider").data('royalSlider');
